...
public class IPermissionActivity extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = "IPermissionActivity";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_i_ermission);
...
//        JPermissionUtil.setManuFacturer("genymotion", MyTestGenymotionMenu.class);
        ...
        transaction.add(R.id.frame_layout, new IPermissionFragment());
        transaction.commit();
    ...
    private void requestService() {
        Intent intent =new Intent(this,IPermissionService.class);
        startService(intent);
    }
